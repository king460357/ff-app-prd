...
**子开关默认值**（未远程覆盖时）：开屏 `hot_start_enable=0`、`inter_time_sec=60`、`max_per_session=10`；插页 `interval_episodes=2`（**看2集弹**）、`inter_time_sec=0`、`max_per_play_session=0`。详见 PRD **5.1.4 / 5.2.4**。
